...
@SpringBootTest
public class OrganizationConstructionServiceImplTest {
    @Autowired
    OrganizationConstructionServiceImpl organizationConstructionService;
    ...
    public void constructionTest() throws Exception{
        ...
        boolean out = organizationConstructionService.construction(baikePage);
