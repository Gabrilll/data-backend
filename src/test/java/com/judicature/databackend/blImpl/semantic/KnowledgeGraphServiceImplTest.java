...
@SpringBootTest
public class KnowledgeGraphServiceImplTest {
    @Autowired
    KnowledgeGraphServiceImpl knowledgeGraphService;

    @Test
    public void getKnowledgeGraphVOTest() throws Exception{
        ...
        List<KnowledgeGraphVO> res = knowledgeGraphService.getKnowledgeGraphVO(polysemantNamedEntities);
        Assert.assertNotNull(res);
    }

    @Test
    public void getInstanceTest() throws Exception{
        KnowledgeGraphService knowledgeGS = KnowledgeGraphServiceImpl.getInstance();
    }
}
