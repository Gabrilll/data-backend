...
import com.judicature.databackend.bl.semantic.SemanticGraphService;
import com.judicature.databackend.enums.NounsTagEnum;
import com.judicature.databackend.enums.VerbsTagEnum;
...
public class SemanticGraphServiceImpl implements SemanticGraphService {
     ...
     * @return
     */
    public static SemanticGraphService getInstance() {
    ...
    public SemanticGraph buildSemanticGraph(CoNLLSentence coNLLsentence, List<PolysemantNamedEntity> polysemantNamedEntities) {
        ...
        // 名词性结点集合
        ArrayList<SemanticGraphVertex> semanticGraphVertexs = new ArrayList<>();

        int index = 0;
        String[] masks = new String[20];
        // 最后处理的边
        List<SemanticGraphEdge> lastProcessEdges = new ArrayList<>();
        // 迭代所有的单词
