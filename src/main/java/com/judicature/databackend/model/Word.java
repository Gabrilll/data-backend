...
import com.judicature.databackend.data.semantic.*;
...
public class Word implements java.io.Serializable {
    ...
    public void active(PolysemantNamedEntity polysemantNamedEntity) {
        for (PolysemantNamedEntity polysemantNamedEntityIter : polysemantNamedEntities) {
            System.out.println(polysemantNamedEntityIter.getEntityName());
    ...
    public PolysemantNamedEntity acquireActiveEntity() {
        ...
        for (PolysemantNamedEntity polysemantNamedEntity : polysemantNamedEntities) {
            if (polysemantNamedEntity.isActive() && constructionDAO.getIndividual(polysemantNamedEntity.getUUID())!=null) {
